#ifndef __CONTAINERS_PRETTY__
#define __CONTAINERS_PRETTY__
...
namespace std
{
    ...
    template<typename T, typename Hash, typename TTraits, typename TAllocator> class unordered_set;
...
// Mark set as a container
template<typename T, typename THash, typename TTraits, typename TAllocator> struct is_container<std::unordered_set<T, THash, TTraits, TAllocator> > : public std::true_type { };
